        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead>
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500">제품</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500">판매량</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500">수익</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500">성장률</th>
                </tr>
              </thead>
              <tbody className="bg-white divide-y divide-gray-200">
                {[
                  ...
                  <tr key={index}>
                    ...
                    <td className="px-6 py-4 text-sm text-gray-500">{product.revenue}</td>
